...
const ProductPage = () => {
  ...
  const getData = async () => {
    const response = await fetch(`http://${url_port}/api/product/item`, {
      method: "POST",
      headers: {
    ...
    <>
      <div className="container d-flex justify-content-between my-4">
        ...
        <div style={{ width: "750px", height: "700px" }}>
          ...
          <p style={{ marginTop: "0px" }}> {data.productDescription} </p> <br />
          ...
          <table>
            <tbody>
              ...
              <tr>
                <td> Pincode </td> <td> {data.pincode} </td>{" "}
              </tr>{" "}
              <tr>
                <td> Contact No </td> <td> {data.contact} </td>{" "}
              </tr>{" "}
            </tbody>{" "}
          </table>{" "}
          <br />
          ...
          <table>
            <tbody>
              <tr>
                <th> Rent - Tenure </th> <th> Price </th>{" "}
              </tr>{" "}
              <tr>
                <td> 0 - 15 Days </td> <td> ₹75 / Day </td>{" "}
              </tr>{" "}
              <tr>
                <td> 1 Month </td> <td> ₹60 / Day </td>{" "}
              </tr>{" "}
              <tr>
                <td> 3 Months </td> <td> ₹50 / Day </td>{" "}
              </tr>{" "}
              <tr>
                <td> 6 Months </td> <td> ₹40 / Day </td>{" "}
              </tr>{" "}
              <tr>
                <td> 12 Months </td> <td> ₹25 / Day </td>{" "}
              </tr>{" "}
            </tbody>{" "}
          </table>{" "}
          <br />
